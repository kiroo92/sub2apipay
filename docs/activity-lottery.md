...
| 奖励       | 抽取权重 | 库存 | 发放方式                  |
| ---------- | -------: | ---: | ------------------------- |
| `$2` 额度  |      550 | 不限 | 自动增加 Sub2API 账户余额 |
| `$5` 额度  |      300 | 不限 | 自动增加 Sub2API 账户余额 |
| `$10` 额度 |      100 | 不限 | 自动增加 Sub2API 账户余额 |
| `$20` 额度 |       40 | 不限 | 自动增加 Sub2API 账户余额 |
| `$50` 额度 |        5 |    5 | 自动增加 Sub2API 账户余额 |
| 订阅重置卡 |        5 |    5 | 用户联系管理员人工兑换    |
